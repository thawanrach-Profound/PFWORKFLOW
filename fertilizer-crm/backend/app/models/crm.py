...
class PromotionGift(Base):
    ...
    is_pinned      = Column(Boolean, default=False)      # ปักหมุดให้อยู่ลำดับแรกในตารางสต๊อก
    unit_cost      = Column(Numeric(10, 2), default=0)    # ต้นทุนต่อชิ้น ใช้คำนวณงบประมาณที่ใช้ไป
